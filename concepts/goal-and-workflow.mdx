...
<Columns cols={2}>
  ...
  <Card title="L'agent vagabonde" icon="route">
    Sans but précis, il sous-tire (il en fait trop peu) ou il sur-ingénierie et part en vrille (le *context dérive*). Le périmètre n'est borné par rien.
  </Card>
</Columns>
