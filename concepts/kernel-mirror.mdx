...
<Note>
  État d'implémentation. Le calcul complet du blast radius et sa cascade dépendent du DAG de versions et du moteur de changesets — **à venir** (S20, S24). La forme du miroir versionné existe déjà (S02, S06).
</Note>
